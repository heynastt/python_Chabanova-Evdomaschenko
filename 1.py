...
font_path = os.path.join(base_dir, "font", "BadeenDisplay-Regular.ttf")
...
TITLE_FONT = pygame.font.Font("font/BadeenDisplay-Regular.ttf", 70)
...
class Plblock:
    def __init__(self):  # ПАРАМЕТРЫ ИГРОВОГО БЛОКА
        ...
        self.image = pygame.image.load("plblock.png")
...
class Ball:
    def __init__(self):
        ...
        self.plblock_bounce_sound = pygame.mixer.Sound("bounce_plblock.mp3")
        self.break_block_sound = pygame.mixer.Sound("break_block.mp3")
...
class Game:
    def __init__(self):
        self.lives = 3
        self.score = 0
        self.losing_life_sound = pygame.mixer.Sound("losing_life.mp3")
...
title_text = TITLE_FONT.render("Hungry Meow", True, (255, 255, 255))
high_score = 0
